...
//        $whimsy_colors_css .= 'background: ' . get_theme_mod('whimsy_masthead_text_color') . ';';
//    }
//    // check if it's empty
//    if( '' != get_theme_mod('whimsy_site_desc_color') ) {
//        $whimsy_colors_css .= 'font-weight: ' . get_theme_mod('sitetitle_weight') . ';';
//    }
//    // check if it's empty
//    if( '' != get_theme_mod('whimsy_site_title_color' ) ) {
//        $whimsy_colors_css .= 'font-style: ' . get_theme_mod('sitetitle_style') . ';'; 
//    }
//    
//    // if variable $custom_css has changed, then add the changes and execute wp_add_inline_style
//    if( '' != $whimsy_colors_css ) {
//        $whimsy_colors_css = '.site-title {' . $custom_css . '}';
//        wp_add_inline_style( 'theme-specific', $whimsy_colors_css );
//    }
//
//}
//
//add_action( 'wp_enqueue_scripts', 'mytheme_custom_styles' );
	...
	$whimsy_masthead_bg_color = get_option( 'whimsy_masthead_bg_color' );
	if( $whimsy_masthead_bg_color ) {
		$whimsy_masthead_bg_color = get_theme_mod( 'whimsy_masthead_bg_color' );
		$whimsy_masthead_bg_color_css .= '
            #masthead { background: ' . esc_html($whimsy_masthead_bg_color) . '; }
		';
	}
    
	if( '' != $whimsy_masthead_bg_color_css ) { wp_add_inline_style( 'whimsy-customizer-colors', $whimsy_masthead_bg_color_css );}
